...
/**
 * Created by Matthijs on 12-11-2014.
 */
...
public class MyAnalogClock extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int availableWidth = Math.round(getResources().getDimension(R.dimen.clock_dimens));
        int availableHeight = Math.round(getResources().getDimension(R.dimen.clock_dimens));
